...
1. identify internet-facing sites running a vulnerable plugin or application
2. test an upload or code-execution primitive
3. place a marker-bearing PHP or PHTML file
4. request the uploaded file and validate its output
5. replace or supplement it with a larger webshell
6. merge successful URLs into a common inventory
7. return to selected systems for credentials, administrator access, and persistent backdoors
...
* CVE-2026-48907 - Joomla JCE - Arbitrary file upload to remote code execution
* CVE-2026-31843 - Pay-UZ - Unauthenticated remote code execution
* CVE-2026-29014 - MetInfo CMS - Unauthenticated remote code execution
* CVE-2026-6433 - Custom CSS JS & PHP - SQL injection to remote code execution
* CVE-2026-4882 - User Registration Advanced Fields - Arbitrary file upload
* CVE-2026-3844 - Breeze Cache - Arbitrary file upload
* CVE-2026-3395 - MaxSite CMS - Remote code execution
* CVE-2026-3300 - Everest Forms Pro - PHP code injection
* CVE-2026-1969 - ThemeREX Addons - Arbitrary file upload
* CVE-2026-1357 - WPvivid Backup - Path traversal and arbitrary file upload
* CVE-2026-0740 - Ninja Forms File Uploads - Path traversal and arbitrary file upload
* CVE-2025-34085 - Simple File List - Arbitrary file upload and rename to remote code execution
* CVE-2025-32432 - Craft CMS - Pre-authentication remote code execution
* CVE-2025-23921 - Multi Uploader for Gravity Forms - Unauthenticated arbitrary file upload
* CVE-2025-13486 - ACF Extended - Unauthenticated remote code execution
* CVE-2025-12352 - Gravity Forms - Server-side request forgery to arbitrary file upload
...
* CVE-2025-6389 - Sneeit Framework - Arbitrary function execution
* CVE-2025-5394 - Alone WordPress Theme - Arbitrary plugin installation to remote code execution
* CVE-2024-34102 - Adobe Commerce/Magento - XML external entity injection
* CVE-2024-11613 - WP File Upload - Remote code execution
* CVE-2024-8856 - WP Time Capsule - Arbitrary file upload
* CVE-2024-6648 - PrestaShop AP Page Builder - Absolute path traversal and arbitrary file read
...
> By the time Ctrl-Alt-Intel recovered and dumped the open-directory, the exploitation script used was `wp_rce_v8.py`. Evidence suggests the threat actor heavily leveraged AI in development of scripts:

[![1](/assets/images/wp2/2.png){: .align-center .img-border}](/assets/images/wp2/2.png)
<p class="figure-caption">AI developed Wordpress RCE script</p>
...
[![1](/assets/images/wp2/4.png){: .align-center .img-border}](/assets/images/wp2/4.png)
<p class="figure-caption">Breeze Cache - CVE-2026-3844</p>
...
[![1](/assets/images/wp2/5.png){: .align-center .img-border}](/assets/images/wp2/5.png)
<p class="figure-caption">Simple File List - CVE-2025-34085</p>
...
- `id`
- hostname and operating-system data
- WordPress paths
- `wp-config.php`
...
A persistent shell was written as:
...
- upload, edit, rename, delete, and permission changes
- system and PHP-environment collection
- command execution in some variants
- session-based authentication
- crawler blocking
- HTTP 404 responses used as camouflage
...
* Perl, C, PHP, and fsockopen reverse shells
* a PHP Meterpreter stage loader
* host, PHP, patch, antivirus, WAF, cloud-agent, and EDR discovery
* port scanning, HTTP proxying, internal URL access, and remote payload download
* MySQL administration, arbitrary SQL, server-side file reads and writes
* embedded x86 and x64 MySQL UDF DLLs for command execution as the database service
* recursive credential-file searches, mass code injection, replacement, cleanup, and web-shell scanning

The webshell came in-built with set commands that could be run:

[![1](/assets/images/wp2/6.png){: .align-center .img-border}](/assets/images/wp2/6.png)
<p class="figure-caption">In-build commands</p>
...
[![1](/assets/images/wp2/7.png){: .align-center .img-border}](/assets/images/wp2/7.png)
<p class="figure-caption">Hotfixes</p>


[![1](/assets/images/wp2/8.png){: .align-center .img-border}](/assets/images/wp2/8.png)
...
[![1](/assets/images/wp2/3.png){: .align-center .img-border}](/assets/images/wp2/3.png)
<p class="figure-caption">linux.sh</p>
