---
title: "ClickFix via WordPress, Mirai Botnets and Cybercriminal Fueds"
classes: wide
header:
  teaser: /assets/images/click/logo.png
ribbon: black
description: "How an exposed C2 exposed the back-end of a cybercrime operation, including threat actors beefing."
categories:
  - Threat Research
tags:
  - Threat Research
...
* Attempts to build staged & evasive ClickFix delivery infrastructure via compromised WordPress sites
* Attempts to construct Mirai-style botnets 
* Attempts to DDOS other cybercrime malware operations and governments using compromised WordPress sites

Among the confirmed victims was **TGI Fridays**, another researcher has previously linked this particular IOCs & ClickFix kill-chain to deliver **KongTuke**. We have not verified this claim. 
...
Ctrl-Alt-Intel has not independently attributed this malware delivery campaign to KongTuke. 
