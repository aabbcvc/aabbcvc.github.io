...
This browser-based checker determines whether a domain name or IP address appeared in the exploitation evidence reviewed by Ctrl-Alt-Intel in our blog [Chinese actor compromises thousands of Wordpress sites](https://ctrlaltintel.com/wordpress). Results are separated into four evidence levels:
